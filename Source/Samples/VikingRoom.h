...
class VikingRoom : public Vulk {
    ...
    void createGraphicsPipeline(char const *vert_shader_path, char const *frag_shader_path) {
...
public:
    void init() override {
        ...
        createTextureImage(TEXTURE_PATH.c_str(), textureImageMemory, textureImage);
