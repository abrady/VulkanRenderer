...
inline void loadModel(char const *model_path, std::vector<Vertex> &vertices, std::vector<uint32_t> &indices) {
...
inline std::vector<char> readFileIntoMem(const std::string& filename) {
