...
protected:
    ...
    // TODO: this function is suspicious: transitionImageLayout doesn't use its second parameter
    inline VkImage createTextureImage(char const *texture_path, VkDeviceMemory& textureImageMemory, VkImage& textureImage) {
